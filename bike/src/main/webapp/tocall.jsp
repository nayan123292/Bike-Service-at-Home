...
String uname = "root";
String pass ="";
String query = "select first_name,last_name,mobile_no,pincode,address,dt,vehicle,date_of_service,type_of_service from bkservice1 where date_of_service=date_add(curdate(),interval -1 month);";
